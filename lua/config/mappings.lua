...
Keymap("n" , "<C-h>", function()  vim.cmd.wincmd("h") end, {desc = "switch to left window"})
Keymap("n" , "<C-j>", function()  vim.cmd.wincmd("j") end, {desc = "switch to left window"})
Keymap("n" , "<C-k>", function()  vim.cmd.wincmd("k") end, {desc = "switch to left window"})
Keymap("n" , "<C-l>", function()  vim.cmd.wincmd("l") end, {desc = "switch to left window"})
