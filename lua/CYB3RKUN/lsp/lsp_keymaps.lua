...
local keymaps = function(client, bufnr)
	...
	keymap("n", "<leader>ds", require("telescope.builtin").lsp_document_symbols,
		{ buffer = bufnr, desc = "[D]ocument [S]ymbols" })

	keymap("n", "<leader>ws", require("telescope.builtin").lsp_dynamic_workspace_symbols,
		{ buffer = bufnr, desc = "[W]orkspace [S]ymbols" })

	keymap("n", "<leader>waf", vim.lsp.buf.add_workspace_folder,
		{ buffer = bufnr, desc = "[W]orkspace [A]dd [F]older" })

	keymap("n", "<leader>wrf", vim.lsp.buf.remove_workspace_folder,
